...
$issue = $_GET['title'];
$buttonAction = strval($_POST["button"]);
$upId = strval($_POST['title']);
...
} elseif(isset($buttonAction) && isset($upId)){
  $stmt2 = $conn->query("UPDATE issues SET stat = '$buttonAction', updated = NOW() WHERE title='$upId'");
}
?>
